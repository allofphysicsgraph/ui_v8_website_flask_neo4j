...
# When a Python file (a module) is imported, the Python interpreter
# executes every line of code in that file, from top to bottom.
from library.initialize_neo4j import get_graphdb_driver
...
def to_index():
    ...
    """
    trace_id = trace_id_var.get()
    canonical_url = url_for("to_index").lstrip("/")
    ...
    all_steps, query_time_dict = compute.get_dict_of_steps_in_derivation(
        get_graphdb_driver(), T_and_f_derivation_ID, query_time_dict
    )
...
def to_navigation():
    ...
    """
    trace_id = trace_id_var.get()
    canonical_url = url_for("to_navigation").lstrip("/")
    query_time_dict = {}  # type: query_timing_result_type
...
def to_add_derivation() -> ResponseReturnValue:
    ...
    """
    trace_id = trace_id_var.get()
    canonical_url = url_for("to_add_derivation").lstrip("/")
    query_time_dict = {}  # type: query_timing_result_type
...
def to_edit_expression(expression_id: unique_numeric_id_as_str) -> ResponseReturnValue:
    ...
    symbols_not_in_expression, query_time_dict = compute.get_symbols_not_in_expression(
        expression_dict, symbols_in_expression, get_graphdb_driver(), query_time_dict
    )
...
def to_add_symbols_and_operations_for_expression(
    ...
    query_time_dict, potential_symbols_found_in_Latex_expression = (
        compute.guess_symbols_from_latex(
            get_graphdb_driver(), query_time_dict, expression_dict
        )
    )
...
def to_add_inference_rule() -> ResponseReturnValue:
    ...
    #         get_graphdb_driver(), query_time_dict, list_of_inference_rule_dicts
    #     )
    # )
...
def to_api_documentation() -> ResponseReturnValue:
    ...
    """
    canonical_url = url_for("to_api_documentation").lstrip("/")

    return render_template(
        "jinja2_pages/documentation_of_api.html",
...
def to_workflow_documenation() -> ResponseReturnValue:
    ...
    ```
    """
    canonical_url = url_for("to_workflow_documenation").lstrip("/")
    return render_template(
...
@web_app.route("/documentation/llm_workflow")
@trace_execution
def to_llm_workflow_documenation() -> ResponseReturnValue:
    """ """
    canonical_url = url_for("to_llm_workflow_documenation").lstrip("/")
...
def my_profile():
    ...
    """
    trace_id = trace_id_var.get()
    canonical_url = url_for("my_profile").lstrip("/")
    query_time_dict = {}  # type: query_timing_result_type
...
def to_evaluation_of_LLM_prompts():
    """ """
    canonical_url = url_for("to_evaluation_of_LLM_prompts").lstrip("/")
    return render_template(
        "jinja2_pages/documentation_evaluation_of_LLM_prompts.html",
        canonical_url=canonical_url,
    )
...
def to_documentation_overview():
    ...
    - workflow
    """
    canonical_url = url_for("to_documentation_overview").lstrip("/")
    return render_template(
        "jinja2_pages/documentation_overview.html",
        title="Overview of Documentation",
        canonical_url=canonical_url,
    )


@web_app.route("/documentation/agentic_LLMs", methods=["GET", "POST"])
@trace_execution
def to_agentic_LLM_documentation():
    """
    a static page with documentation on use of agentic LLMs
    """
...
def to_student_documentation():
    ...
    """
    canonical_url = url_for("to_student_documentation").lstrip("/")
    return render_template(
...
def to_instructor_documentation():
    ...
    """
    canonical_url = url_for("to_instructor_documentation").lstrip("/")
    return render_template(
...
def to_researcher_documentation():
    ...
    """
    canonical_url = url_for("to_researcher_documentation").lstrip("/")
    return render_template(
...
def to_user_documentation():
    ...
    """
    canonical_url = url_for("to_user_documentation").lstrip("/")
    return render_template(
        "jinja2_pages/documentation_for_user.html",
...
def to_developer_documentation():
    ...
    """
    canonical_url = url_for("to_developer_documentation").lstrip("/")
    return render_template(
        "jinja2_pages/documentation_for_developer.html",
...
def to_conventions_documentation():
    ...
    design decisions
    """
    canonical_url = url_for("to_conventions_documentation").lstrip("/")
    return render_template(
...
def to_design_documentation():
    ...
    design decisions
    """
    canonical_url = url_for("to_design_documentation").lstrip("/")
    return render_template(
...
def to_document_dimensionality():
    """ """
    canonical_url = url_for("to_document_dimensionality").lstrip("/")
    return render_template(
        "jinja2_pages/documentation_dimensionality.html",
...
def to_faq():
    ...
    """
    canonical_url = url_for("to_faq").lstrip("/")
    return render_template(
        "jinja2_pages/documentation_faq.html",
...
def to_other_projects():
    ...
    """
    canonical_url = url_for("to_other_projects").lstrip("/")
    return render_template(
        "jinja2_pages/documentation_other_projects.html",
...
def to_literature_review():
    ...
    """
    canonical_url = url_for("to_literature_review").lstrip("/")

    return render_template(
        "jinja2_pages/documentation_literature_review.html",
...
def to_comparison_of_design_options_cas():
    ...
    a static page
    """
    canonical_url = url_for("to_comparison_of_design_options_cas").lstrip("/")
    return render_template(
...
def to_comparison_of_design_options_graph_drawing():
    ...
    a static page
    """
    canonical_url = url_for("to_comparison_of_design_options_graph_drawing").lstrip("/")
    return render_template(
...
def to_comparison_of_design_options_proofs():
    ...
    a static page
    """
    canonical_url = url_for("to_comparison_of_design_options_proofs").lstrip("/")
    return render_template(
...
def to_comparison_of_design_options_syntax():
    ...
    a static page
    """
    canonical_url = url_for("to_comparison_of_design_options_syntax").lstrip("/")
    return render_template(
...
def to_comparison_of_design_options_database():
    ...
    a static page
    """
    canonical_url = url_for("to_comparison_of_design_options_database").lstrip("/")
    return render_template(
...
def to_list_named_expressions():
    ...
    ```
    """
    canonical_url = url_for("to_list_named_expressions").lstrip("/")
    return render_template(
        "jinja2_pages/named_expressions_list.html",
        title="central expressions",
        canonical_url=canonical_url,
    )
...
def to_survey_of_named_expressions():
    ...
    """
    canonical_url = url_for("to_survey_of_named_expressions").lstrip("/")
    return render_template(
        "jinja2_pages/named_expressions_survey.html",
        title="central expressions",
        canonical_url=canonical_url,
    )
...
def to_blog_list():
    """ """
    canonical_url = url_for("to_blog_list").lstrip("/")
...
def to_spectrum_of_precision():
    ...
    """
    canonical_url = url_for("to_spectrum_of_precision").lstrip("/")
    return render_template(
        "jinja2_pages/layers_overview.html",
        title="Spectrum of Precision: Overview",
        canonical_url=canonical_url,
    )
...
def to_validate_latex():
    ...
    """
    trace_id = trace_id_var.get()
    canonical_url = url_for("to_validate_latex").lstrip("/")
...
def to_validate_sympy():
    """TODO"""
    canonical_url = url_for("to_validate_sympy").lstrip("/")
    return render_template(
        "jinja2_pages/validate_sympy.html",
        title="validate SymPy",
        canonical_url=canonical_url,
    )
...
def to_validate_lean():
    trace_id = trace_id_var.get()
    canonical_url = url_for("to_validate_lean").lstrip("/")
...
def to_validate_json():
    ...
    """
    trace_id = trace_id_var.get()
    canonical_url = url_for("to_validate_json").lstrip("/")
...
@web_app.route("/validate/SYMBOLS_json", methods=["GET", "POST"])
@trace_execution
def to_validate_SYMBOLS_json():
    """
    does SYMBOLS.json generated by LLM adhere to schema?
    """
    trace_id = trace_id_var.get()
    canonical_url = url_for("to_validate_SYMBOLS_json").lstrip("/")
...
@web_app.route("/validate/OPERATIONS_json", methods=["GET", "POST"])
@trace_execution
def to_validate_OPERATIONS_json():
    """
    does OPERATIONS.json generated by LLM adhere to schema?
    """
    trace_id = trace_id_var.get()
    canonical_url = url_for("to_validate_OPERATIONS_json").lstrip("/")
    ...
    return render_template(
        ...
        title="validate OPERATIONS.json",
        json_is_valid=json_is_valid,
        canonical_url=canonical_url,
        json_result=json_result,
        form_json=web_form_json,
...
@trace_execution
def to_validate_EXPRESSIONS_json():
    """
    does EXPRESSIONS.json generated by LLM adhere to schema?
    """
    trace_id = trace_id_var.get()
    canonical_url = url_for("to_validate_EXPRESSIONS_json").lstrip("/")
    ...
    return render_template(
        ...
        title="validate EXPRESSIONS.json",
        json_is_valid=json_is_valid,
        canonical_url=canonical_url,
        json_result=json_result,
        form_json=web_form_json,
...
@web_app.route("/validate/STEPS_json", methods=["GET", "POST"])
@trace_execution
def to_validate_STEPS_json():
    """
    does STEPS.json generated by LLM adhere to schema?
    """
    trace_id = trace_id_var.get()
    canonical_url = url_for("to_validate_STEPS_json").lstrip("/")
    ...
    return render_template(
        ...
        title="validate STEPS.json",
        json_is_valid=json_is_valid,
        canonical_url=canonical_url,
        json_result=json_result,
        form_json=web_form_json,
        path_to_revised_STEPS_json=revised_filename,
    )


@web_app.route("/validate/DERIVATION_json", methods=["GET", "POST"])
@trace_execution
def to_validate_DERIVATION_json():
    """
    does DERIVATION.json generated by LLM adhere to schema?
    """
    trace_id = trace_id_var.get()
    canonical_url = url_for("to_validate_DERIVATION_json").lstrip("/")
    ...
    return render_template(
        ...
        title="validate DERIVATION.json",
        json_is_valid=json_is_valid,
        canonical_url=canonical_url,
        json_result=json_result,
        form_json=web_form_json,
...
@web_app.route(
    "/rewrite_OPERATIONS_with_local_IDs_json_with_matched_OPERATIONS_json",
    methods=["GET", "POST"],
)
@trace_execution
def rewrite_OPERATIONS_json_using_matched_IDs():
    """
    See https://allofphysics.com/documentation/agentic_LLMs
    """
    trace_id = trace_id_var.get()
    canonical_url = url_for("rewrite_OPERATIONS_json_using_matched_IDs").lstrip("/")

    operations_json_is_valid = True
    matches_json_is_valid = True
    revised_OPERATIONS_with_local_ID_created = False
    web_form_json = NoOptionsForm()
    revised_filename = ""
    ...
    if request.method == "POST":
        ...
        user_operations_json_input = request.form["operations-json-input"]

        user_matches_json_input = request.form["matches-json-input"]

        if user_operations_json_input == "":
            flash("Nothing submitted for OPERATIONS_with_local_IDs.json")
        elif user_matches_json_input == "":
            flash("Nothing submitted for OPERATIONS_matched.json")
        else:
            try:
                parsed_operations_json_input = json.loads(user_operations_json_input)
                operations_json_is_valid = True
            except ValueError as err:
                # json_result = str(err) + "\n\n" + user_json_input
            ...
            if matches_json_is_valid and operations_json_is_valid:
                # at this point both files have valid schemas
                # merge the two files
                for match_index, matched_operation in enumerate(
                    parsed_matches_json_input
                ):
                    for local_index, this_local_operation in enumerate(
                        parsed_operations_json_input
                    ):
                        if (
                            matched_operation["local_id_in_derivation"]
                            == this_local_operation["operation ID"]
                        ):
                            parsed_operations_json_input[local_index]["pdg_id"] = (
                                matched_operation["pdg_id"]
                            )

                # produce the merged file with a unique filename
                revised_filename = (
                    "OPERATIONS_with_local_IDs_and_PDG_IDs_"
                    + str(uuid.uuid4())
                    + ".json"
                )
                logger.info(revised_filename)
                with open("static/" + revised_filename, "w") as file_handle:
                    json.dump(parsed_operations_json_input, file_handle, indent=2)

                revised_OPERATIONS_with_local_ID_created = True

    return render_template(
        "jinja2_pages/user_workflow/rewrite_OPERATIONS_json_using_matched_IDs.html",
        title="rewrite OPERATIONS.json using matched ID",
        canonical_url=canonical_url,
        form_json=web_form_json,
        revised_OPERATIONS_with_local_ID_created=revised_OPERATIONS_with_local_ID_created,
        path_to_revised_OPERATIONS_json=revised_filename,
    )
