...
def to_add_value_and_units(scalar_id: unique_numeric_id_as_str) -> werkzeug.Response:
    ...
    with graphDB_Driver.session() as session:
        ...
        query_time_dict[
            "pdg_app/to_add_value_and_units: get_all_expressions_for_every_value "
            + trace_id
        ] = round(time.time() - query_start_time, 3)
...
def to_api_documentation() -> str:
    ...
    """
    return render_template("jinja2_pages/documentation_of_api.html",title="API Documentation")
...
def to_workflow_documenation() -> str:
    ...
    ```
    """
    return render_template("jinja2_pages/documentation_of_workflow.html", title="Workflow documentation")
