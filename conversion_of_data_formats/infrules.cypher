...
UNWIND [{id:"111469",
         properties:{name_latex:"X cross both sides by",
                     ...
                     author_name_latex:"ben.is.located@gmail.com",
                     notes_latex:"",
                     assumptions_latex:"linear algebra",
...
UNWIND [{id:"111463",
         properties:{name_latex:"apply divergence",
                     ...
                     author_name_latex:"ben.is.located@gmail.com",
                     notes_latex:"",
                     assumptions_latex:"multi-variable calculus",
...
UNWIND [{id:"111490",
         properties:{name_latex:"apply function to both sides of expression",
                     ...
                     number_of_outputs:1,
                     author_name_latex:"ben.is.located@gmail.com",
                     notes_latex:"Example: apply sin(x) to 'a = b + c'",
                     assumptions_latex:"",
...
UNWIND [{id:"111390",
         properties:{name_latex:"apply operator to bra",
                     ...
                     author_name_latex:"ben.is.located@gmail.com",
                     notes_latex:"",
                     assumptions_latex:"quantum: Dirac notation",
...
UNWIND [{id:"111484",
         properties:{name_latex:"conjugate both sides",
                     ...
                     author_name_latex:"ben.is.located@gmail.com",
                     notes_latex:"",
                     assumptions_latex:"complex values",
...
UNWIND [{id:"111696",
         properties:{name_latex:"conjugate transpose both sides",
                     ...
                     author_name_latex:"ben.is.located@gmail.com",
                     notes_latex:"",
                     assumptions_latex:"complex valued linear algebra",
...
UNWIND [{id:"111237",
         properties:{name_latex:"declare guess solution",
                     ...
                     number_of_outputs:1,
                     author_name_latex:"ben.is.located@gmail.com",
                     notes_latex:"https://en.wikipedia.org/wiki/Ansatz",
                     assumptions_latex:"",
...
UNWIND [{id:"111649",
         properties:{name_latex:"differentiate with respect to",
                     ...
                     author_name_latex:"ben.is.located@gmail.com",
                     notes_latex:"",
                     assumptions_latex:"differential equations",
...
UNWIND [{id:"111408",
         properties:{name_latex:"integrate",
                     ...
                     number_of_outputs:1,
                     author_name_latex:"ben.is.located@gmail.com",
                     notes_latex:"not clear how to specify limits for an arbitrary number of integrals",
                     assumptions_latex:"multi-variable calculus",
...
UNWIND [{id:"111295",
         properties:{name_latex:"separate vector into two trigonometric ratios",
                     ...
                     number_of_outputs:2,
                     author_name_latex:"ben.is.located@gmail.com",
                     notes_latex:"geometry argument in 2D",
                     assumptions_latex:"",
...
UNWIND [{id:"111524",
         properties:{name_latex:"square root both sides",
                     ...
                     number_of_outputs:2,
                     author_name_latex:"ben.is.located@gmail.com",
                     notes_latex:"related to raise both sides to power",
                     assumptions_latex:"",
...
UNWIND [{id:"111222",
         properties:{name_latex:"subtract expr 1 from expr 2",
                     ...
                     number_of_outputs:1,
                     author_name_latex:"ben.is.located@gmail.com",
                     notes_latex:"complement of 'add expr X to expr Y'",
                     assumptions_latex:"",
